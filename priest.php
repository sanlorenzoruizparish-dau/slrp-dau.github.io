		...
		<div class="header-top about-header-top">
			<div class="container banner-drop">
				<div class="agile-logo">
						<a href="index.php"><img class="logomenu" src="images/logo1.png"></a>
					</div>
					<div class="header-right">
							<nav>
							  <ul>
								...
								<li>
									<a href="service.php"><span>SEVICES</span></a>
								</li>
								<li>
									<a href="contact.php"><span>CONTACT US</span></a>
								</li>
								<li>
									<a href="faqs.php"><span>FAQS</span></a>
								</li>
							  </ul>
							</nav>
				  ...
				  <div class="col-md-3">
					  ...
					  <div class="list-group panel">
					    ...
					    <div class="collapse" id="demo3">
					      ...
					      <a href="about.php" class="list-group-item">San Lorenzo Ruiz</a>
					    </div>
					    ...
					    <div class="collapse" id="demo4">
					      ...
					      <a href="mission.php" class="list-group-item">Mission & Vision</a>
					      
					    </div>
					    <a href="priest.php" class="list-group-item list-group-item-info strong" data-parent="#MainMenu">PRIESTS</i></a>
					    <a href="events.php" class="list-group-item list-group-item-info strong" data-parent="#MainMenu">EVENTS</i></a>
					  </div>
					</div>	
				  </div>
									...
									<div class="col-sm-3 team-grid">
										...
										<div class="ih-item circle effect10 bottom_to_top">
											...
											<div class="info">
												...
												<a href="http://www.rcasf.com/index.php/priest/those-in-god-s-kingdom/323-rev-msgr-gregorio-binuya.html">Priest Bio</a>
											</div>
										</div>
										<!-- end normal -->
									</div>
									<div class="col-sm-3 team-grid">
										...
										<div class="ih-item circle effect10 bottom_to_top">
											...
											<div class="info">
												...
												<a href="http://www.rcasf.com/index.php/priest/in-active-ministry/35-musni-eduardo-gomez.html">Priest Bio</a>
											</div>
										</div>
										<!-- end normal -->
									</div>
									<div class="col-sm-3 team-grid">
										...
										<div class="ih-item circle effect10 bottom_to_top">
											...
											<div class="info">
												...
												<a href="http://www.rcasf.com/index.php/priest/in-active-ministry/40-rev-msgr-mercado-eugenio-jr-santos.html">Priest Bio</a>
									...
									<div class="col-sm-3 team-grid">
										...
										<div class="ih-item circle effect10 bottom_to_top">
											...
											<div class="info">
												...
												<a href="http://www.rcasf.com/index.php/priest/on-leave/76-deceased-clergy/177-rev-msgr-serrano-andres-sicat.html">Priest Bio</a>
									...
									<div class="col-sm-3 team-grid">
										...
										<div class="ih-item circle effect10 bottom_to_top">
											...
											<div class="info">
												...
												<a href="http://rcasf.com/index.php/priest/in-active-ministry/25-pineda-arnel-lumbang.html">Priest Bio</a>
									...
									<div class="col-sm-3 team-grid">
										...
										<div class="ih-item circle effect10 bottom_to_top">
											...
											<div class="info">
												...
												<a href="http://www.rcasf.com/index.php/priest/in-active-ministry/22-manalang-alvin-modesto-siopongco.html">Priest Bio</a>
