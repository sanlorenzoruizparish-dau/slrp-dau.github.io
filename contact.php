		...
		<div class="container">
			<div class="agile-contact-form">
				<div class="col-md-6 contact-form-left">
					...
					<p>To inquire about our Parish <a href="service.php"><b>services</b></a> you can reach us by fill in/up the form.</p>
				...
				<div class="col-md-6 contact-form-right">
                    ...
                    <div class="agileinfo-contact-form-grid">
                        <form method="post" name="slrp" action="user_process.php">
